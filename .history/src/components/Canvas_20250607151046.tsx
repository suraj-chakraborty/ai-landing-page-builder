  ...
  const handleDrop = (e: React.DragEvent<HTMLDivElement>) => {
    ...
    setSections((prev: Section[]) => {
      if (overlappingIndex !== -1) {
        ...
        const ComponentLibrary = COMPONENTS[newComponent.type]?.[newComponent.library as keyof typeof COMPONENTS[typeof newComponent.type]];
