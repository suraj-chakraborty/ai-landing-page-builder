...
const availableComponents: Component[] = Object.entries(COMPONENTS).map(
  ([type, libraries]) => {
    const [firstLibrary, _componentDef] = Object.entries(libraries)[0];
    return {
      type: type as keyof typeof COMPONENTS,
      library: firstLibrary as Component["library"],
      label: `${type} (${firstLibrary})`,
    };
  }
);
